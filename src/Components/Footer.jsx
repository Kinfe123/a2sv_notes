...
const Footer = () => {
    return (
        <div className="px-5">
            <footer className=" border-t !w-full py-5 my-1 justify-between flex items-center">
                    <div className=" flex  gap-2 text-md font-medium items-center">
                    ...
                    <span className="text-gray-700 dark:text-stone-300 font-light text-sm flex justify-center items-center">
                        {new Date().getFullYear()} © WeFarm
                    </span>
                    <div className=" flex items-center gap-2">
                        <Link href="https://twiiter.com/AfriFarm">
                            <svg
                                width="18"
                                height="18"
                                viewBox="0 0 16 16"
                        ...
                        <Link href="https://github.com/Kinfe">
                            <svg
                                width="18"
                                height="18"
                                viewBox="0 0 16 16"
                        ...
                        <Link href="https://discord.gg/asas">
                            <svg
                                className=" w-5 h-5"
                                viewBox="0 0 24 24"
                                fill="none"
                    ...
                    <div className="flex flex-row justify-center items-center mb-5 ">
                      Made with {" "}<span className="px-1 pb-2 inline"><Coffee /> </span>-  <a className="underline underline-offset-4" href="https://kinfish-owns-computer.vercel.app/" rel='noreferrer' target="_blank">KINFEMICHAEL TARIKU</a>
                    </div>
