...
export const HeroSection = () => {
  return (
    <div className="mt-14 relative flex justify-center items-center max-w-8xl card bg-gradient-circle w-full  px-8 py-10 pb-8 from-gray-50 to-gray-200   dark:from-brand-900/20 dark:to-stone-950/80 sm:min-h-fit md:px-16 md:py-12  md:pt-16 rounded-3xl">
        ...
        >
          ...
          >
            <div className="mx-auto flex items-center justify-center gap-3">
              ...
              🎉   {'  '}Intership - New Grad 2024 Opening 
              </h2>
          ...
          <div className="flex justify-center items-center gap-3 font-semibold">
            ...
            <div className="text-md flex gap-4 text-black dark:text-white sm:flex-col 2xl:text-lg">
              ...
              <div className="flex gap-2">
                ...
                <span className="">Enjoy You Stay With Us.</span>
              </div>
            </div>
          </div>
          <div className="mt-10 flex  flex-col  justify-center items-center gap-6 font-semibold sm:flex-row">
            {/* <a
              className={cn(
